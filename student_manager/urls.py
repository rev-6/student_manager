...
from app.views import main, admin_student, start_work_session, stop_work_session, admin_dashboard, admin_student_delete, admin_student_edit, admin_student_create, admin_rule_list, admin_rule_edit, view_rules, accept_rules, student_message_list, dashboard, admin_student_list, admin_message_list, student_registration, public_working_students
...
urlpatterns = [
    ...
    path('admin/students/<int:pk>/view/', admin_student, name='admin_student_view'),
